...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://aouazqh4h0.execute-api.us-east-1.amazonaws.com/dev';
    ...
    apigClient.uploadBucketKeyPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['key', 'bucket', 'x-amz-meta-customlabels', 'Content-Type', 'Accept'], ['body']);
        ...
        var uploadBucketKeyPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['key', 'bucket', 'x-amz-meta-customlabels', 'Content-Type', 'Accept']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
    ...
    apigClient.uploadBucketKeyOptions = function (params, body, additionalParams) {
        ...
        var uploadBucketKeyOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/upload/{bucket}/{key}').expand(apiGateway.core.utils.parseParametersToObject(params, ['key', 'bucket'])),
            headers: apiGateway.core.utils.parseParametersToObject(additionalParams, ['Access-Control-Allow-Origin', 'Access-Control-Allow-Methods', 'Access-Control-Allow-Headers']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
